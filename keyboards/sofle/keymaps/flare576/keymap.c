 ...
 * |CTRL+W|ALT+A |      |      |      |      |                    |      |      |      |      |      |      |
 * |------+------+------+------+------+------|                    |------+------+------+------+------+------|
 * | TRNS |PRNTSC|      | MS_UP| HOME | PGUP |                    |WHL_U |WHL_D |WHL_L |WHL_R |      |COMP1 |
 * |------+------+------+------+------+------|                    |------+------+------+------+------+------|
 * | TRNS |SCRLK |MS_LFT|MS_DN |MS_RT |      |-------.    ,-------|  UP  | DOWN | LEFT |RIGHT |      |COMP2 |
 * |------+------+------+------+------+------| TRNS  |    | TRNS  |------+------+------+------+------+------|
...
[_MOUS] = LAYOUT(
  ...
  _______,    KC_PSCR,    XXXXXXX, MS_UP,   KC_HOME, KC_PGUP,                   MS_WHLU, MS_WHLD, MS_WHLL, MS_WHLR,  XXXXXXX, _COMP1,
  _______,    KC_SCRL,    MS_LEFT, MS_DOWN, MS_RGHT, XXXXXXX,                   KC_LEFT, KC_DOWN, KC_UP,   KC_RIGHT, XXXXXXX, _COMP2,
  _______,    KC_PAUS,    XXXXXXX, XXXXXXX, KC_END,  KC_PGDN, _______, _______, MS_BTN1, MS_BTN2, XXXXXXX, XXXXXXX,  XXXXXXX, XXXXXXX,
                          XXXXXXX, _______, _______, _______, _______, _______, MS_BTN3, MS_BTN4, MS_BTN5, XXXXXXX
),

/* SYMS
 * ,-----------------------------------------.                    ,-----------------------------------------.
 * |      |  F1  |  F2  |  F3  |  F4  | F5   |                    |      |      |   {  |   }  |      |QK_BOT|
 * |------+------+------+------+------+------|                    |------+------+------+------+------+------|
 ...
 * | TRNS | TRNS | TRNS | TRNS | TRNS | TRNS |-------|    |-------| TRNS | TRNS | TRNS | TRNS | TRNS | TRNS |
 * `-----------------------------------------/       /     \      \-----------------------------------------'
 *            | ESDF |      | TRNS | TRNS | / TRNS  /       \ TRNS \  | TRNS |PrntSc| TRNS | TRNS |
 *            |      |      |      |      |/       /         \      \ |      |      |      |      |
 *            `----------------------------------'           '------''---------------------------'
 */
[_FF14] = LAYOUT(
  ...
  _______, _______, _______,   _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,  _______,
                    TO(_ESDF), XXXXXXX, _______, _______, _______, _______, _______, KC_PSCR, _______, _______
),
 ...
 * |------+------+------+------+------+------|                    |------+------+------+------+------+------|
 * |   T  |  Tab |   Q  |   W  |   E  |   R  |                    | TRNS | TRNS | TRNS | TRNS | TRNS | PGUP |
 * |------|------+------+------+------+------+                    |------+------+------+------+------+------|
 * |   G  |LShift|   A  |   S  |   D  |   F  |-------.    ,-------| TRNS | TRNS | TRNS | TRNS | TRNS | PGDN |
 * |------|------+------+------+------+------+       |    |       |------+------+------+------+------+------|
 * | TRNS | TRNS | TRNS | TRNS | TRNS | TRNS |-------|    |-------| TRNS | TRNS | TRNS | TRNS | TRNS |   M  |
 * `-----------------------------------------/       /     \      \-----------------------------------------'
 *            | TRNS |      | TRNS | TRNS | / TRNS  /       \ TRNS \  | TRNS |PrnScr| TRNS | FF14 |
 *            |      |      |      |      |/       /         \      \ |      |      |      |      |
 *            `----------------------------------'           '------''---------------------------'
 */
[_ESDF] = LAYOUT(
  _______, _______, _______, _______, _______, _______,                   _______, _______, _______, _______, _______, KC_EQL,
  KC_T,    KC_TAB,  KC_Q,    KC_W,    KC_E,    KC_R,                      _______, _______, _______, _______, _______, KC_PGUP,
  KC_G,    KC_LSFT, KC_A,    KC_S,    KC_D,    KC_F,                      _______, _______, _______, _______, _______, KC_PGDN,
  _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, KC_M,
